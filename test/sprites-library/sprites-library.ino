...
DESCRIPTION:
    Demonstration program showing how to set up and use the user-defined sprites for
    text animations within the MD_Parola library.
...
const char *msg[] =
{
  "Parola Sprites for your viewing pleasure",
  "Animation"
};
