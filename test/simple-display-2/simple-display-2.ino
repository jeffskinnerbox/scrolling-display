...
void setup() {
    ...
    Serial.begin(9600);
    DEBUGPRINT("\n\r--------------------------------------------------------------------------------");
    DEBUGTRACE(INFO, "Entered setup()...\n\r");
    DEBUGTRACE(INFO, "Initializing simple scrolling display...\n\r");
    DEBUGTRACE(INFO, "simple scrolling display version = ", version);
    ...
    DEBUGTRACE(INFO, "Initializing WiFi...\n\r");
    WT.wifiScan();
