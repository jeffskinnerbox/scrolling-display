...
// Just for fun!
// taken from https://github.com/MajicDesigns/MD_MAX72XX/blob/master/examples/MD_MAX72xx_Pacman/MD_MAX72xx_Pacman.ino
...
// pacman project's include files (~/src/scrolling-display/test/pacman)
...
#define PRINTC(s, v)  { Serial.print(F(s)); Serial.println((char)v); }  // Print a string followed by a value (char)
